...
class EpsonCoordinator(DataUpdateCoordinator[dict[str, Any]]):
    ...
    async def _async_update_data(self) -> dict[str, Any]:
        ...
        # Probe the rest. One ERR shouldn't kill the whole poll — log and skip.
        for query in _ON_STATE_QUERIES:
            try:
                ...
                _LOGGER.warning("Lost ESC/VP21 connection during %s: %s", query, err)
